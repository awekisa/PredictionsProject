...
{
    [McpOperation(McpScopes.AppRead)]
    ...
    [McpOperation(McpScopes.PredictionsWrite, "gameId")]
    ...
    internal static McpPage<T> Page<T>(IEnumerable<T> source, int offset, int limit)
    {
